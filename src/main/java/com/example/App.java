...
public class App {
    ...
    private static void testRelationsEtCascade(EntityManagerFactory emf) {
        ...
        try {
            ...
            // Création de l'entite utilisateur ~~
            Utilisateur utilisateur = new Utilisateur("Samir", "Jabir", "samir-jabir@example.com");

            // Création de l'entite salle ~~
            Salle salle = new Salle("Salle I2", 50);
            salle.setDescription("Salle de réunion équipée d'un projecteur");

            // Création de l'entite réservation ~~
            ...
            // Établissement des relations entre les entites
    ...
    private static void testSuppressionOrpheline(EntityManagerFactory emf) {
        ...
        try {
            ...
            Utilisateur utilisateur = new Utilisateur("Alae", "Himad", "alae.himad@example.com");

            Salle salle1 = new Salle("Salle I6", 20);
            em.persist(salle1);

            Salle salle2 = new Salle("Salle I8", 15);
            em.persist(salle2);
    ...
    private static void testRelationManyToMany(EntityManagerFactory emf) {
        ...
        try {
            ...
            // Création des salles
            Salle salleReunion = new Salle("Salle de formation D114", 50);
            Salle salleFormation = new Salle("Salle de réunion A103", 20);
